...
<!-- Modal content-->
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 style="color:red;"><span class="glyphicon glyphicon-check"></span> 개인정보수정</h4>
		</div>
		<div class="modal-body">
			<form role="form" id="modifyMyInfoForm" method="post">
				...
				<table style="width:100%;">
					...
					<tr>
						<td>가입일</td>
						<td id="createdDate" style="text-align:left;">
					...
					<tr>
						<td>커미션</td>
						<td><input type="text" class="form-control" name="commission" style="width:90%;" id="commission" readonly/></td>
						<td>추천인ID</td>
