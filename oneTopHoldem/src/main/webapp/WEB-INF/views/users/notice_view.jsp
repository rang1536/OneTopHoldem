...
<div id="warp">
	...
	<div id="content">
		...
		<div id="container">
			...
			<div id="tab">
				<ul>
					<li class="over" onclick="location.href='notice_list.html'">전체</li>
					<li onclick="location.href='notice_list.html'">공지</li>
					<li onclick="location.href='notice_list.html'">점검</li>
				</ul>
			</div>
			...
			<div style="padding:10px 0 15px 0"><a href="notice_list.html" class="btn01">이전글</a> <a href="notice_list.html" class="btn01">다음글</a> <a href="notice_list.html" class="btn01">목록보기</a></div>
		</div>
	</div>
