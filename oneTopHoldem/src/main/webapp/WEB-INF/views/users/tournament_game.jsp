	...
	<div id="content">
		<div id="aside">
			...
			<div class="sub_menu">
				<ul>
					...
					<li class="over"><a href="tournamentGame">· 토너먼트란?</a></li>
		...
		<div id="container">
			<div style="padding-bottom:10px;">
				<span id="container_title">토너먼트란?</span>
				<div class="sub_nav"><img src="resources/img/home_icon.jpg"> HOME&nbsp;&nbsp;>&nbsp;&nbsp;토너먼트&nbsp;&nbsp;>&nbsp;&nbsp;<b>토너먼트란?</b></div>
			</div>
			...
			<div style="font-size:14pt;font-weight:600;color:#092a88;">♣ 토너먼트 용어</div>
			<div id="notice_list">
