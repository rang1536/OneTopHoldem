...
<script>
function result_pop(url){

	var popupX = (window.screen.width / 2) - (430 / 2);
	var popupY= (window.screen.height /2) - (600 / 2);

	window.open(url, '원탑홀덤 토너먼트 경기결과', 'status=no, height=600, width=430, left='+ popupX + ', top='+ popupY + ', screenX='+ popupX + ', screenY= '+ popupY);
}
</script>
</head>
<body>
...
<div id="warp">
	...
	<div id="content">
		...
		<div id="container">
			...
			<div id="tab">
				<ul>
					<li onclick="location.href='tournamentMenu'">일정</li>
					<li class="over" onclick="location.href='tournamentResult'">결과</li>
				</ul>
			</div>
			...
			<div id="notice_list">
				<table width=100% cellpadding=0 cellspacing=0>
					...
					<tr>
						...
						<td class="name"><a href="javascript:result_pop('tournamentResultView');" class="btn02">결과보기</a></td>
					</tr>
					<tr bgcolor=#f6f6f6>
						<td class="date">2018-01-09 20:00</td>
						<td class="subject">300억 빅토너 가는길! 15,000 티켓 (3장)</td>
