	...
	<div id="content">
		<div id="aside">
			...
			<div class="sub_menu">
				<ul>
					...
					<li class="over"><a href="noticeList">· 공지사항</a></li>
		...
		<div id="container">
			<div style="padding-bottom:10px;">
				<span id="container_title">공지사항</span>
				<div class="sub_nav"><img src="resources/img/home_icon.jpg"> HOME&nbsp;&nbsp;>&nbsp;&nbsp;고객센터&nbsp;&nbsp;>&nbsp;&nbsp;<b>공지사항</b></div>
			</div>
			...
			<div id="tab">
				<ul>
					<li class="over" onclick="location.href='noticeList'">전체</li>
					<li onclick="location.href='noticeList'">공지</li>
					<li onclick="location.href='noticeList'">점검</li>
				</ul>
			</div>
			...
			<div id="notice_list">
				<table width=100% cellpadding=0 cellspacing=0>
					...
					<tr>
						<td class="num"><img src="resources/img/notice_icon1.jpg"></td>
						<td class="subject"><a href="noticeView">[점검완료] 1/04 (목) "홀덤" 서버 점검 완료(9:00 ~11:00)</a></td>
						<td class="date">2018-01-01</td>
					</tr>
					<tr>
						<td class="num"><img src="resources/img/notice_icon1.jpg"></td>
						<td class="subject"><a href="notice_view.html">[점검완료] 1/04 (목) "홀덤" 서버 점검 완료(9:00 ~11:00)</a></td>
						<td class="date">2018-01-01</td>
					</tr>
					<tr>
						<td class="num"><img src="resources/img/notice_icon2.jpg"></td>
						<td class="subject"><a href="notice_view.html">[점검완료] 1/04 (목) "홀덤" 서버 점검 완료(9:00 ~11:00)</a></td>
						<td class="date">2018-01-01</td>
					</tr>
					<tr>
